...
document.querySelector("#learn").addEventListener("click", function() {
  var diceDOM = document.querySelector("#laptop");
  diceDOM.style.display = "block";
  diceDOM.src = "img/d-1.jpg";
});
document.querySelector("#pic-1").addEventListener("click", function() {
  var diceDOM = document.querySelector("#laptop");
  diceDOM.style.display = "block";
  diceDOM.src = "img/d-1.jpg";
});
document.querySelector("#pic-2").addEventListener("click", function() {
  var diceDOM = document.querySelector("#laptop");
  diceDOM.style.display = "block";
  diceDOM.src = "img/d-2.jpg";
});
document.querySelector("#pic-3").addEventListener("click", function() {
  var diceDOM = document.querySelector("#laptop");
  diceDOM.style.display = "block";
  diceDOM.src = "img/d-3.jpg";
});
...
tl.from("#T", 0.5, { x: 200, opacity: 0 });
tl.from("#span", 1, { width: 0 }, "=-.5");
tl.from("#I", 1, { x: -200, opacity: 0, ease: Power4.easeInOut }, "=-1");
tl.from("#But", 1, { x: 200, opacity: 0, ease: Power4.easeInOut }, "=-.7");
tl.from(
  "#three-container",
  1,
...
function init() {
  ...
  slide.setImage(l1.load("img/d-1.png"));
  root.scene.add(slide);

  var slide2 = new Slide(width, height, "in");
  var l2 = new THREE.ImageLoader();
  l2.setCrossOrigin("Anonymous");
  slide2.setImage(l2.load("img/d-2.jpg"));
